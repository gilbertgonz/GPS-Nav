...
def main():
    ...
    oneFrame =customtkinter.CTkFrame(root, width=100, height = 480)
    oneFrame.grid(row=0, column=0, columnspan=2, padx=1, pady=5)

    leftFrame1 =customtkinter.CTkFrame(root, width=200, height = 480)
    leftFrame1.grid(row=1, column=0, padx=5, pady=5)

    rightFrame1 =customtkinter.CTkFrame(root, width=200, height = 100)
    rightFrame1.grid(row=1, column=1, padx=5, pady=5)

    rightFrame2 =customtkinter.CTkFrame(root, width=200, height = 100)
